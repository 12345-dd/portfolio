...
const projects = [
...

  {
    ...
    description:
      "Developed a desktop-only React application that integrates multiple utilities such as Weather, News, Movies, Notes, Timer and To-Do List into a single platform.",
